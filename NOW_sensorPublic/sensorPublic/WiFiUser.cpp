...
const char* AP_SSID  = "imu-1";        // 设置AP热点名称
//const char* AP_PASS  = "";               // 这里不设置设置AP热点密码
 
const char* HOST_NAME = "imu-1";        // 设置设备名
...
//IPAddress destination_ip(192, 168, 1, 103);  // 接收方设备的IP地址
...
<div class="container">
    <form method="POST" action="configwifi">
        ...
        <div class="input-container">
            <span>Send Name:</span>
            <input type="password" name="SendName">
        </div>
        <label class="label">
        ...
        <div class="input-container">
            <span>Send Rate:</span>
            <input type="password" name="SendRate">
        </div>
        <label class="label">
        ...
        <div class="input-container">
            <span>Wifi Ip:</span>
            <input type="password" name="WifiIp">
        </div>
        <label class="label">
